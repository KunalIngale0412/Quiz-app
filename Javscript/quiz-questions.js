const questions = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "In which year did the Indian cricket team win their first Cricket World Cup?",
        options: ["1983", "1992", "1996", "2011"],
        correctAnswer: 0,
      },
      {
        question: " What is the national sport of Canada?",
        options: ["Hockey", "Baseball", "Baseketball", "Lacrosse"],
        correctAnswer: 3,
      },
      {
      ...
      },
      {
        ...
        options: ["Baseketball", "Volleyball", "Tennis", "Football"],
        correctAnswer: 0,
      },
      {
      ...
      },
      {
        ...
        options: ["Love", "Blank", "Nil", "Void"],
        correctAnswer: 0,
      },
      {
        question: "Which sport is played at Wimbledon?",
        options: ["Cricket", "Golf", "Tennis", "Fotball"],
        correctAnswer: 2,
      },
      {
        question: "What is the distance of a standard Olympic swimming pool?",
      ...
      },
      {
        ...
        options: ["Wallabies", "Springboks", "All Blacks", "Pumas"],
        correctAnswer: 2,
      },
      {
        question: " How long is a marathon race?",
        options: ["26.2 miles", "21.5 miles", "24 miles", "30 miles"],
        correctAnswer: 0,
      },
    ],
  },
